...
export default {
  ...
  methods: {
    ...
    renderExceedLimitTip() {
      ...
      return (
        <div
          class="vue-treeview__limit-tip vue-treeview-helper-zoom-effect-off"
          key="exceed-limit-tip"
        >
          <span class="vue-treeview__limit-tip-text">
  ...
  render() {
    ...
    const transitionGroupProps = {
      props: {
        tag: "div",
        name: "vue-treeview__multi-value-item--transition",
        appear: true
      }
    };
    ...
    return renderValueContainer(
      <transition-group
        class="vue-treeview__multi-value"
