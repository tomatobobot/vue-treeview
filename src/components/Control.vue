...
export default {
  ...
  methods: {
    renderX() {
      ...
      return (
        <div
          class="vue-treeview__x-container"
          title={title}
          onMousedown={this.handleMouseDownOnX}
        >
          <DeleteIcon class="vue-treeview__x" />
        </div>
      );
    },
    ...
    renderArrow() {
      const { instance } = this;
      const arrowClass = {
        "vue-treeview__control-arrow": true,
        "vue-treeview__control-arrow--rotated": instance.menu.isOpen
      };
      ...
      return (
        <div
          class="vue-treeview__control-arrow-container"
    ...
    renderValueContainer(children) {
      return <div class="vue-treeview__value-container">{children}</div>;
    }
  },
  ...
  render() {
    ...
    return (
      <div class="vue-treeview__control" onMousedown={instance.handleMouseDown}>
